      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto bg-surface border-border/30">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="title" className="text-sm font-semibold text-foreground bg-surface px-2 py-1 rounded">Título da Tarefa</Label>
            <Input
              id="title"
              value={title}
          ...
          {/* Description */}
          <div className="space-y-2">
            <Label htmlFor="description" className="text-sm font-semibold text-foreground bg-surface px-2 py-1 rounded">Descrição</Label>
            <RichTextEditor
              content={description}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="status" className="text-sm font-semibold text-foreground bg-surface px-2 py-1 rounded">Status da Tarefa</Label>
            ...
            <div className="space-y-2">
              <Label className="text-sm font-semibold text-foreground bg-surface px-2 py-1 rounded">Prioridade</Label>
          ...
          {/* Due Date */}
          <div className="space-y-2">
            <Label className="text-sm font-semibold text-foreground bg-surface px-2 py-1 rounded">Data de Conclusão</Label>
            <Popover>
          ...
          <div className="space-y-3">
            <Label className="text-sm font-semibold text-foreground bg-surface px-2 py-1 rounded">Tags da Tarefa</Label>
            ...
            <div className="border border-border/30 rounded-lg p-4 bg-muted/20">
              <Label className="text-sm font-medium text-foreground bg-surface px-2 py-1 rounded mb-3 block">Criar Tag Personalizada</Label>
